...
region_params(idx).effective_NA = 0.615; %0.615 5/8 new ao; 0.625; % 0.625 no orb with na corr; 0.632; % 0.635 on p2obj; no orb 0.632;  w orb 0.61; no orb 0.632 % 11/11/21 0.62  before 11/11/21 0.605;
...
region_params(idx).AO_correction_fname =  'AO_correction_25x_maitai_5_10_23.mat'; %'AO_correction_25x_maitai_4_16_23.mat'; % 'AO_correction_25x_maitai_11_21_21.mat';
region_params(idx).point_weight_correction_fname = [];
region_params(idx).xyz_offset = [0 0 0]; % baseline beam offset
region_params(idx).xy_over_z_offset = [-0.014 0.012]; % no orb w na corr [-0.014 0.012]%no orb [-0.02 0.006]; worb[0.027 -0.012]; % axial beam offset by z
