...
region_params(idx).effective_NA = 0.618; %0.615 5/8 new ao; 0.625; % 0.625 no orb with na corr; 0.632; % 0.635 on p2obj; no orb 0.632;  w orb 0.61; no orb 0.632 % 11/11/21 0.62  before 11/11/21 0.605;
...
region_params(idx).AO_correction_fname =  'AO_correction_25x_maitai_5_17_23.mat'; %'AO_correction_25x_maitai_4_16_23.mat'; % 'AO_correction_25x_maitai_11_21_21.mat';
