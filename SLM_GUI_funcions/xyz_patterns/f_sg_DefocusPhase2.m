...
% third strategy, integal the taylor expansion of phase equation, similar to strategy 2
% phase =  z * objectiveRI * k * (1 - Rho.^2*sin_alpha^2/2 - Rho.^4*sin_alpha^4/8 - Rho.^4*sin_alpha^6/16)
bias = objectiveRI*k*(1 - sin_alpha^2/4 - sin_alpha^4/24 - sin_alpha^6/64 - sin_alpha^8/128);  %   - (sin_alpha^6)/64 - sin_alpha^8/128
