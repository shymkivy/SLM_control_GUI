function [ NOVOCGH ] = function_NOVO_CGH_TPEuclid( System, HStacks, Masks,Depths )
% This computes Two photon NOVO-CGH holgorams by directly optimizing for I^2
%with an euclidean cost function. 
if System.verbose == 1
    disp(['NOVO-CGH for Two-Photon holography with I^2 cost function, computation begins']);
end;
...
f = @(x)function_FunObj_TPEuclid( x, System.source, Depths, System.Nx, System.Ny, maskfun, kernelfun, System.useGPU);
...
if System.verbose == 1
    t = toc; 
    disp(['NOVO-CGH for Two-Photon holography with I^2 cost function - Completed in ' int2str(t) ' seconds !']);
end;
end
